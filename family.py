...
#
__version__='$Id: family.py 10236 2012-05-24 06:59:31Z xqt $'
    ...
    def __init__(self):
        ...
        self.namespaces = {
            ...
            2: {
                ...
                'ku': u'Bikarhêner',
                'kv': [u'Участник', u'Участница'],
                'kw': u'Devnydhyer',
                'la': u'Usor',
                'lad': [u'Usador', u'Usuario', u'Empleador', u'Usuaria'],
                'lb': [u'Benotzer', u'Benutzer', u'Benutzerin'],
                'lbe': u'Гьуртту хьума',
                'lez': [u'Участник', u'Участница'],
                'li': u'Gebroeker',
                'lij': u'Utente',
                ...
                'myv': u'Теиця',
                'mzn': [u'کارور', u'کاربر'],
                'nah': [u'Tlatequitiltilīlli', u'Usuario', u'Usuaria'],
                'nap': u'Utente',
                ...
                'qu': [u'Ruraq', u'Usuario', u'Usuaria'],
                'rm': u'Utilisader',
                'rmy': u'Jeno',
                'ro': u'Utilizator',
                ...
                'sv': u'Användare',
                'sw': u'Mtumiaji',
                'szl': [u'Użytkownik', u'Użytkowniczka'],
                'ta': u'பயனர்',
                ...
                'yi': [u'באַניצער', u'באנוצער', u'באניצער', u'משתמש', u'משתמשת'],
                'yo': u'Oníṣe',
                'za': u'用户',
                'zea': u'Gebruker',
                'zh': [u'User', u'用户', u'用戶'],
            ...
            3: {
                ...
                'am': u'አባል ውይይት',
                'an': [u'Descusión usuario', u'Usuario Discusión', u'Usuaria Discusión'],
                ...
                'bar': [u'Benutzer Diskussion', u'Benutzerin Diskussion'],
                ...
                'frp': [u'Discussion usanciér', u'Discussion Utilisator'],
                ...
                'nah': [u'Tlatequitiltilīlli tēixnāmiquiliztli', u'Usuario Discusión', u'Usuaria Discusión'],
                ...
                'pfl': [u'Benutzer Diskussion', u'Benutzerin Diskussion'],
                'pi': u'अवयव सम्भासित',
                ...
                'qu': [u'Ruraq rimanakuy', u'Usuario Discusión', u'Usuaria Discusión'],
                ...
                'szl': [u'Dyskusja użytkownika', u'Dyskusja użytkowniczki'],
                'ta': u'பயனர் பேச்சு',
                ...
                'yi': [u'באַניצער רעדן', u'באנוצער רעדן', u'באניצער רעדן', u'שיחת משתמש', u'שיחת משתמשת'],
                'yo': u'Ọ̀rọ̀ oníṣe',
                'za': [u'用户讨论', u'用户对话'],
            ...
            6: {
                ...
                'ast': [u'Archivu', u'Imaxe', u'Imaxen'],
                'av': [u'Файл', u'Изображение'],
                'ay': [u'Archivo', u'Imagen'],
                'az': u'Şəkil',
                'ba': [u'Рәсем', u'Изображение'],
                'bar': [u'Datei', u'Bild'],
            ...
            7: {
                ...
                'ast': [u'Archivu alderique', u'Imaxe alderique', u'Imaxen discusión'],
                'av': [u'Обсуждение файла', u'Обсуждение изображения'],
                'ay': [u'Archivo discusión', u'Imagen Discusión'],
                'az': u'Şəkil müzakirəsi',
                'ba': [u'Рәсем б-са фекер алышыу', u'Обсуждение изображения'],
                ...
                'gan': [u'File talk', u'圖像對話', u'圖像討論', u'檔案對話', u'檔案討論', u'文件對話', u'文件討論'],
                ...
                'lez': [u'Обсуждение файла', u'Обсуждение изображения'],
                ...
                'pfl': [u'Datei Diskussion', u'Bild Diskussion'],
                'pi': u'पटिमा सम्भासित',
                ...
                'udm': [u'Суред сярысь вераськон', u'Обсуждение изображения'],
                ...
                'war': u'Hiruhimangraw hiton fayl',
            ...
            9: {
                ...
                'war': u'Hiruhimangraw hiton MediaWiki',
            ...
            11: {
                ...
                'gan': [u'Template talk', u'樣板對話', u'樣板討論', u'模板對話', u'模板討論'],
            ...
            13: {
                ...
                'ast': [u'Aida alderique', u'Ayuda discusión'],
            ...
            15: {
                ...
                'gan': [u'Category talk', u'分類對話', u'分類討論'],
                ...
                'he': u'שיחת קטגוריה',
                'hi': [u'श्रेणी वार्ता', u'श्रवा', u'CT'],
