...
Configuration parameters:
  url = http://stategovernmentsintheunitedstates.wikia.com
  name = stategovernmentsintheunitedstates
...
class Family(family.Family):
    def __init__(self):
        ...
        self.name = 'stategovernmentsintheunitedstates'
        self.langs = {
            'en': u'stategovernmentsintheunitedstates.wikia.com',
        }

        self.namespaces[4] = self.namespaces.get(4, {})
        self.namespaces[4]['en'] = [u'Stategovernmentsintheunitedstates Wiki']
        self.namespaces[5] = self.namespaces.get(5, {})
        self.namespaces[5]['en'] = [u'Stategovernmentsintheunitedstates Wiki talk']
